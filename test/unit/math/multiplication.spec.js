...
describe("unit.resolve.multiplication", () => {
  describe("Should resolve simple operations with one element", () => {
    it("Should resolve multiplication with 0", () => {
      const operation = ['*', 0]
      const result = resolve(operation)
      expect(result).to.be.equals(0)
    })

    it("Should resolve multiplication with 1", () => {
      const operation = ['*', 1]
      const result = resolve(operation)
      expect(result).to.be.equals(1)
    })

    it("Should resolve multiplication with an element", () => {
      const operation = ['*', 7]
      const result = resolve(operation)
      expect(result).to.be.equals(7)
    })

    it("Should resolve multiplication with a negative element", () => {
      const operation = ['*', -7]
      const result = resolve(operation)
      expect(result).to.be.equals(-7)
    })
  ...
  describe("Should resolve simple operations with two elements", () => {
    it("Should resolve multiplication with double 0", () => {
      const operation = ['*', 0, 0]
      const result = resolve(operation)
      expect(result).to.be.equals(0)
    })

    it("Should resolve multiplication with 0 and 1", () => {
      const operation = ['*', 0, 1]
      const result = resolve(operation)
      expect(result).to.be.equals(0)
    })

    it("Should resolve multiplication with 0 and any number", () => {
      const operation = ['*', 0, 7]
      const result = resolve(operation)
      expect(result).to.be.equals(0)
    })

    it("Should resolve multiplication with double 1", () => {
      const operation = ['*', 1, 1]
      const result = resolve(operation)
      expect(result).to.be.equals(1)
    })

    it("Should resolve multiplication with 1 and any number", () => {
      const operation = ['*', 1, 7]
      const result = resolve(operation)
      expect(result).to.be.equals(7)
    })

    it("Should resolve multiplication with any element and another any element", () => {
      const operation = ['*', 7, 9]
      const result = resolve(operation)
      expect(result).to.be.equals(63)
    })

    it("Should resolve multiplication with a negative element and another any element", () => {
      const operation = ['*', -7, 9]
      const result = resolve(operation)
      expect(result).to.be.equals(-63)
    })
  ...
  describe("Should resolve simple operations with multiple elements", () => {
    it("Should resolve multiplication with all values as 0", () => {
      const operation = ['*', 0, 0, 0]
      const result = resolve(operation)
      expect(result).to.be.equals(0)
    })

    it("Should resolve multiplication with some 0", () => {
      const operation = ['*', 0, 1, 0]
      const result = resolve(operation)
      expect(result).to.be.equals(0)
    })

    it("Should resolve multiplication with at least one 0", () => {
      const operation = ['*', 0, 3, 2]
      const result = resolve(operation)
      expect(result).to.be.equals(0)
    })

    it("Should resolve multiplication with all values as 1", () => {
      const operation = ['*', 1, 1, 1]
      const result = resolve(operation)
      expect(result).to.be.equals(1)
    })

    it("Should resolve multiplication with two values as 1", () => {
      const operation = ['*', 1, 7, 1]
      const result = resolve(operation)
      expect(result).to.be.equals(7)
    })

    it("Should resolve multiplication with at least one 1", () => {
      const operation = ['*', 7, 1, 9]
      const result = resolve(operation)
      expect(result).to.be.equals(63)
    })

    it("Should resolve multiplication with all elements different", () => {
      const operation = ['*', 1, 2, 3]
      const result = resolve(operation)
      expect(result).to.be.equals(6)
    })

    it("Should resolve multiplication with all elements with same value but greater than 1", () => {
      const operation = ['*', 2, 2, 2]
      const result = resolve(operation)
      expect(result).to.be.equals(8)
    })

    it("Should resolve multiplication with some elements value but one of them negative", () => {
      const operation = ['*', 2, -2, 2]
      const result = resolve(operation)
      expect(result).to.be.equals(-8)
    })

    it("Should resolve multiplication with a positive element", () => {
      const operation = ['*', 2, -2, -2]
      const result = resolve(operation)
      expect(result).to.be.equals(8)
    })

    it("Should resolve multiplication with negative elements with same value but abs greater than 1", () => {
      const operation = ['*', -2, -2, -2]
      const result = resolve(operation)
      expect(result).to.be.equals(-8)
    })
  ...
  describe("Should resolve double nested operations", () => {
    ...
    it("Should resolve double nested operations", () => {
      const operation = ['*', 2, ['*', 2, ['*', 3, 4]]]
      const result = resolve(operation)
      expect(result).to.be.equals(48)
    })
  })
})
